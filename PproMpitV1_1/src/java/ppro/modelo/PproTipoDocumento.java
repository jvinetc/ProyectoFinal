...
public class PproTipoDocumento implements Serializable {
    ...
    private List<PproDocumento> pproDocumentoCollection;
    ...
    @XmlTransient
    public List<PproDocumento> getPproDocumentoCollection() {
        return pproDocumentoCollection;
    }

    public void setPproDocumentoCollection(List<PproDocumento> pproDocumentoCollection) {
    ...
    public String toString() {
        return "ppro.modelo.PproTipoDocumento[ tdocId=" + tdocId + " ]";
    }
