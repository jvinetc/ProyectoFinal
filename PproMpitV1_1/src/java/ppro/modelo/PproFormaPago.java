...
public class PproFormaPago implements Serializable {
    ...
    @OneToMany(mappedBy = "docFormPagId")
    private List<PproDocumento> pproDocumentoList;
    ...
    public String toString() {
        return "ppro.modelo.PproFormaPago[ fpagId=" + fpagId + " ]";
    }

    @XmlTransient
    public List<PproDocumento> getPproDocumentoList() {
        return pproDocumentoList;
    }

    public void setPproDocumentoList(List<PproDocumento> pproDocumentoList) {
        this.pproDocumentoList = pproDocumentoList;
    }
