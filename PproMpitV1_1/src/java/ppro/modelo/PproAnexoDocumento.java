...
public class PproAnexoDocumento implements Serializable {
    ...
    @Size(max = 255)
    @Column(name = "ane_nombre")
    private String aneNombre;
    ...
    public String toString() {
        return "ppro.modelo.PproAnexoDocumento[ aneId=" + aneId + " ]";
    }

    public String getAneNombre() {
        return aneNombre;
    }

    public void setAneNombre(String aneNombre) {
        this.aneNombre = aneNombre;
    }
