...
@NamedQueries({
    ...
    @NamedQuery(name = "PproTipoAnexo.findByTanTipoProveedor", query = "SELECT p FROM PproTipoAnexo p WHERE p.tanTiproId = :tanTiproId AND p.tanNombre= :tanNombre" ),})
@ManagedBean
@RequestScoped
public class PproTipoAnexo implements Serializable {
    ...
    public String toString() {
        return "ppro.modelo.PproTipoAnexo[ tanId=" + tanId + " ]";
    }
